#ifndef HILL__UTILS__XML_WRITER_HH_INCLUDED
#define HILL__UTILS__XML_WRITER_HH_INCLUDED
...
namespace hill::utils {
	...
	struct xml_writer {
		...
		void set_attribute(const std::string &key, const std::string &value)
		{
			...
			auto &s = section_stack.back();
			s.attribs[key] = xml_escape_string(value.c_str());
		}
...
#endif /* HILL__UTILS__XML_WRITER_HH_INCLUDED */
