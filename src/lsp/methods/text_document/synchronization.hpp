#ifndef HILL__LSP__METHODS__TEXT_DOCUMETN__SYNCHRONIZATION_HPP_INCLUDED
#define HILL__LSP__METHODS__TEXT_DOCUMETN__SYNCHRONIZATION_HPP_INCLUDED
...
#endif /* HILL__LSP__METHODS__TEXT_DOCUMETN__SYNCHRONIZATION_HPP_INCLUDED */
